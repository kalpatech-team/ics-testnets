#!/bin/bash
# Set up a kalpa service to join the kalpa-1 chain.
...
CHAIN_BINARY_URL='https://raw.githubusercontent.com/kalpatech-team/ics-testnets/main/game-of-chains-2022/kalpa/kalpad'
CHAIN_BINARY='kalpad'
CHAIN_ID=kalpa
PERSISTENT_PEERS=""
...
echo "Description=kalpa service"            | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the kalpa service:"
